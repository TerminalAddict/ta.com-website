(function() {
    ...
    function B(a, b) {
        function d(b, d, f) {
            ...
            128 < e && (c /= e / 128,
            e = 128),
            48 <= c && 48 <= e && (b.drawImage(f, c / -2, e / -2, c, e),
            b.translate(0, e / 2 + 32)));
            b.fillText(v, k / -2, 0);
        ...
        E && (c("msapplication-starturl", a.start_url || "/"),
        ...
        "fullscreen" === q ? (c("x5-fullscreen", "true"),
        c("full-screen", "yes")) : g && (c("x5-page-mode", "app"),
        c("browsermode", "application"));
        if (p) {
    ...
    function D(a) {
        if (p || H) {
            var b = y(a);
            if (p)
                c("apple-mobile-web-app-status-bar-style", b ? "black" : "default");
            else {
                try {
                ...
                null === d ? console.debug("UWP no titleBar") : (d.foregroundColor = r(b ? "black" : "white"),
                d.backgroundColor = r(a))
            }
        }
    }
    function r(a) {
    ...
    function z(a, b, d) {
        ...
        var c = u(a);
        c.drawImage(a, 0, 0);
        if (!d && 255 == c.getImageData(0, 0, 1, 1).data[3])
            return null;
