...
"noreferrer noopener");$(this).attr("data-bs-toggle","tooltip");$(this).attr("title",$(this).attr("href"))});var e=$(location).attr("href").replace("terminaladdict.com","www.loudas.com");$(".notfoundLink").html(e);$(".notfoundLink").attr("href",e)});$("a[data-mail]").on("click",function(){window.location="mailto:"+$(this).data("mail")+"@paulwillard.nz?subject=Contact from website"});
$(".searchResults .close").on("click",function(){event.preventDefault();$(".searchResults").addClass("hidden");$(".searchBar").css("height","auto");$(".searchBar").addClass("fadeOut");$(".searchBar").removeClass("fadeIn");$("#overlay").removeClass("overlayon");$("#query").val("")});$('img[rel="lightbox"]').on("click",function(){var a=$(this).attr("src").replace("thumbnails/","");$("#lightboxModalBody").html('<img src="'+a+'" alt="" class="w-100" />');$("#lightboxModal").modal("show")});
