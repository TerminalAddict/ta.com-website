$(document).ready(function(){var a=0;$(window).scroll(function(){50<$(this).scrollTop()?($("#back-to-top").fadeIn(),$("#go-home").fadeIn()):($("#back-to-top").fadeOut(),$("#go-home").fadeOut());var b=$(this).scrollTop();$(".searchResults").is(":hidden");b>a?($(".searchBar").addClass("fadeOut"),$(".searchBar").removeClass("fadeIn"),$("#overlay").removeClass("overlayon")):50>$(this).scrollTop()&&($(".searchBar").addClass("fadeIn"),$(".searchBar").removeClass("fadeOut"));a=b});$("#back-to-top").click(function(){$("#back-to-top").tooltip("hide");
$("body,html").animate({scrollTop:0},800);return!1});$("#back-to-top").mouseover(function(){$("#back-to-top").tooltip("show")});$("img.thumbnail").each(function(){var b=this.width,c=this.height;$(this).attr("height",c);$(this).attr("width",b)});$.ajaxSetup({cache:!1});$("#query").keyup(function(){$(".searchResults").removeClass("hidden");$(".searchBar").css("height","80%");$("#queryResult").html("");50>$(this).scrollTop()&&($("#overlay").addClass("overlayon"),$(".searchBar").addClass("fadeIn"),$(".searchBar").removeClass("fadeOut"));
searchField=$("#query").val();expression=new RegExp(searchField,"i");$.getJSON("/assets/search.json",function(b){$.each(b,function(c,d){if(-1!=d.url.search(expression)||-1!=d.content.search(expression)||-1!=d.title.search(expression))c=d.content.search(expression)-50,c=d.content.substring(c,c+300),""!=searchField&&(c=c.split(expression).join("<span class='shadow bg-primary text-white rounded px-1'>"+searchField+"</span>"),d.title=d.title.split(expression).join("<span class='shadow bg-primary text-white rounded px-1'>"+
searchField+"</span>")),$("#queryResult").append('<li class="list-group-item link-class"><img src="/assets/images/search.svg" alt="search" class="searchIcon" /><a class="pl-5" href="'+d.url+'">'+d.title+'</a><span class="text-muted"> ...'+c+'... </span><a href="'+d.url+'">read more &rArr;</a></li>')})})});$("span.tag").each(function(){var b=Math.floor(4*Math.random())+1,c=Math.floor(5*Math.random())+1;$(this).addClass("display-"+b);$(this).addClass("color-"+c)});$('a[target="_blank"]').each(function(){$(this).attr("rel",
"noreferrer noopener");$(this).attr("data-bs-toggle","tooltip");$(this).attr("title",$(this).attr("href"))});var e=$(location).attr("href").replace("terminaladdict.com","www.loudas.com");$(".notfoundLink").html(e);$(".notfoundLink").attr("href",e);[].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')).map(function(b){return new bootstrap.Tooltip(b)})});$("a[data-mail]").on("click",function(){window.location="mailto:"+$(this).data("mail")+"@paulwillard.nz?subject=Contact from website"});
...
(function(a){function e(b){a(".post__comments-form .js-notice").removeClass("hidden");a(".post__comments-form .js-notice-text").html(b)}a(".js-comments");a("#comment-form").submit(function(){var b=this;a(b).addClass("disabled");a("#comment-form-submit").html("Posting ...");a("#comment-form-submit").attr("disabled",!0);a.ajax({type:a(this).attr("method"),url:a(this).attr("action"),data:a(this).serialize(),contentType:"application/x-www-form-urlencoded",success:function(c){a("#comment-form-submit").html("Submitted");
a(".post__comments-form .js-notice").removeClass("bg-danger").addClass("bg-success");a("#comment-form fieldset").each(function(){a(this).addClass("hidden")});e("<strong>Thanks for your comment!</strong> It will show on the site once it has been approved.")},error:function(c){console.log(c);a("#comment-form-submit").html("Submit Comment");a(".post__comments-form .js-notice").removeClass("bg-success").addClass("bg-danger");e("<strong>Sorry, there was an error with your submission.</strong> Please make sure all required fields have been completed and try again.");
a(b).removeClass("disabled");a("#comment-form-submit").attr("disabled",!1)}});return!1})})(jQuery);
